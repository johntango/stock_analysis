...
### jrw notes - pip install the following crewai, sec_api, dedent, unstructured

### jrw notes - then run poetry install --no-root

### jrw make sure all the necessary API keys are install (in GitHub secrets if running on Codespaces)
